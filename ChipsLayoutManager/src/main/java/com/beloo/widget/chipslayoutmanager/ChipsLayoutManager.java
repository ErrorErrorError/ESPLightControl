...
public class ChipsLayoutManager extends RecyclerView.LayoutManager implements IChipsLayoutManagerContract,
    ...
    private void layoutDisappearingViews(@NonNull RecyclerView.Recycler recycler, @NonNull ILayouter upLayouter, ILayouter downLayouter) {
     ...
     */
    private void fill(@NonNull RecyclerView.Recycler recycler, @NonNull ILayouter backwardLayouter, @NonNull ILayouter forwardLayouter) {
     ...
     */
    private void fillWithLayouter(@NonNull RecyclerView.Recycler recycler, @NonNull ILayouter layouter, int startingPos) {
     ...
     */
    @Override
    public void smoothScrollToPosition(@NonNull RecyclerView recyclerView, RecyclerView.State state, final int position) {
        if (position >= getItemCount() || position < 0) {
            Log.e("span layout manager", "Cannot scroll to " + position + ", item count " + getItemCount());
            return;
        }
    ...
    @Override
    public void onScrolled(IScrollingController scrollingController, @NonNull RecyclerView.Recycler recycler, RecyclerView.State state) {
