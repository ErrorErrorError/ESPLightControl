...
class DisappearingViewsManager implements IDisappearingViewsManager {
    ...
    * buf value */
    ...
    @NonNull
    @Override
    public DisappearingViewsContainer getDisappearingViews(@NonNull RecyclerView.Recycler recycler) {
    ...
    @Override
    public int calcDisappearingViewsLength(@NonNull RecyclerView.Recycler recycler) {
        int removedLength = 0;
