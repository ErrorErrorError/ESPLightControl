...
public abstract class AbstractLayouter implements ILayouter, IBorder {
    ...
    private void calculateView(@NonNull View view) {
    ...
    public final boolean placeView(@NonNull View view) {
    ...
    public final boolean onAttachView(@NonNull View view) {
        calculateView(view);
    ...
    private Rect applyChildGravity(@NonNull View view, Rect viewRect) {
